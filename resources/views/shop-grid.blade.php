            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2>{{$all_typeProduct[$type_id-1]->type_name}}</h2>
                    ...
                    <div class="sidebar">
                        <div class="sidebar__item">
                            ...
                            <ul>
                                ...
                                <li><a href="{{route('shop-grid', ['id'=> $item->id])}}">{{$item->type_name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="sidebar__item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <h6><span>{{count($all_product_by_type_id)}}</span> Products found</h6>
                                </div>
                            </div>
